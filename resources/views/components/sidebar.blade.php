    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('ruangan*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('ruangan.index') }}"><i class="fa fa-tags"></i> <span>Ruangan/Bagian</span></a>
            </li>
            <li class="{{ Request::is('notifikasi*') ? 'active' : '' }}">
                <a class="nav-link" href="#"><i class="fa fa-bell"></i> <span>Notifikasi</span></a>
            </li>
        </ul>
